  ...
  head: () => ({
    meta: [
      ...
      { title: "Vitorino Vitrines — Moda com pagamento no Pix" },
      {
        name: "description",
        content:
          "Roupas, calçados e acessórios selecionados com pagamento direto no Pix. Instale como aplicativo.",
      },
      { name: "theme-color", content: "#2a2118" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Vitorino" },
